            ...
            <div class="signup-form">
                ...
                <form class="form" method="post" action="sign.php">
                    <div class="input-box-wrapper">
                        ...
                        <div class="input-box">
                            <input type="text" minlength="2" name="lastName" id="lastName" placeholder="Last Name" text-only required />
                            <span class="error-icon">
                                <i class='bx bx-error-circle'></i>
                            </span>
                            <span class="check-icon">
                    ...
                    <div class="input-box-wrapper">
                        ...
                        <div class="input-box">
                            <input type="text" name="contact" placeholder="Contact No." pattern="^98\d{8}$" required />
                            <span class="error-icon">
                                <i class='bx bx-error-circle'></i>
                            </span>
                            <span class="check-icon">
...
>>>>>>> 510e6169ef7c89f12758bc8479960a6667eab5d9
                        </select>
                    </div>
                    <div class="check-box">
